<?php namespace Customsell\Sync\Block;
        ...
        if ( $category->hasChildren() )
        {
            ...
            if ( count($childCategories) > 0 )
            {
                ...
                foreach ( $childCategories as $childCategory )
                {
                    ...
                    // echo $childCategory->getDescription();
                    // echo $this->getCategoryUrl($childCategory);

                    $temp                = array();
                    $temp['id']          = $childCategory->getId();
                    $temp['name']        = $childCategory->getName();
                    $temp['description'] = $this->getDescription($childCategory);
                    $temp['url']         = $this->getCategoryUrl($childCategory);
                    $temp['parent']      = $category->getId();
